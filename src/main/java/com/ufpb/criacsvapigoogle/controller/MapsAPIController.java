...
import com.ufpb.criacsvapigoogle.service.LeitorCSVService;
...
public class MapsAPIController {
    ...
    private final LeitorCSVService csvService;

    public MapsAPIController(MapsAPIService service, LeitorCSVService csvService) {
